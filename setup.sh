...
wrangler d1 migrations apply smsflare && ok "Local migrations applied" \
  || warn "Local migrations skipped (not critical for production)"

# ── 4. Migrations (remote / production) ──────────────────────────────────────
...
# ── 9. Deploy dashboard to Cloudflare Pages ───────────────────────────────────
...
# ── 10. Set final URLs in wrangler.toml and redeploy ─────────────────────────
